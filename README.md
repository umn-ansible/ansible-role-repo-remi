...
Available variables are listed below, along with default values (see `defaults/main.yml`):
    ...
    remi_repo_url: "https://rpms.remirepo.net/enterprise/remi-release-{{ ansible_facts.distribution_version }}.rpm"

The URL from which the Remi repo `.rpm` will be downloaded and installed.

    remi_repo_gpg_key_url: "https://rpms.remirepo.net/enterprise/{{ ansible_facts.distribution_version }}/RPM-GPG-KEY-remi"
